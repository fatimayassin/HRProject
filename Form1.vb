...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'x.initheader(Me, UcHeaderTop1, 0)
    ...
    Private Sub Timer1Refresh_Tick(sender As Object, e As EventArgs) Handles Timer1Refresh.Tick
        ...
        If counter = 60 Then
            ...
            Next
        End If
        UcHeaderTop1.reftimer(counter.ToString)
    End Sub

    Private Sub UcHeaderTop1_ClickBtnRefresh() Handles UcHeaderTop1.ClickBtnRefresh
        For Each x In Panel1.Controls
            If x.visible = True Then
                x.refreshdata
                counter = 0
    ...
    Private Sub UcHeaderTop1_SizeChanged(sender As Object, e As EventArgs) Handles UcHeaderTop1.SizeChanged
    ...
    Private Sub Panelsize_MouseDown(sender As Object, e As MouseEventArgs) Handles Panelsize.MouseDown
        If UcHeaderTop1.IsMaximized = False Then
