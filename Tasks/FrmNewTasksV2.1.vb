Public Class Form5
    ...
    Private Sub Form5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'For i As Integer = 0 To ListBoxCompletedTasksToday.Items.Count - 1 Step 1
        '    If i Mod 2 = 0 Then
        '        ListBoxCompletedTasksToday.BackColor = My.Settings.PanelColor
        '    Else
        '        ListBoxCompletedTasksToday.BackColor = Color.White
        '    End If
        'Next i

        'ListBoxCompletedTasksToday.DrawMode = DrawMode.OwnerDrawFixed
    ...
    Private Sub BtAdd_Click(sender As Object, e As EventArgs) Handles BtAdd.Click, NewToolStripMenuItem.Click
      ...
      .TaskIsDone = False
        ...
        Me.NotifyIcon1.BalloonTipText = "New Task Has Been Added" + Environment.NewLine + "Task:" + "  " + NewTask.TaskName + " " + Environment.NewLine + DateTime.Now
    ...
    End Sub
    'Private Sub ListBoxCompletedTasksToday_DrawItem(sender As Object, e As DrawItemEventArgs) Handles ListBoxCompletedTasksToday.DrawItem
    '    If e.Index Mod 2 = 0 Then
    '        e.Graphics.FillRectangle(Brushes.LightGray, e.Bounds)
    '    End If
    '    If ListBoxCompletedTasksToday.SelectedIndex = e.Index Then
    '        e.Graphics.FillRectangle(Brushes.Blue, e.Bounds)
    '        e.Graphics.DrawString(ListBoxCompletedTasksToday.Items(e.Index).ToString, Me.Font, Brushes.White, 0, e.Bounds.Y + 2)
    '    Else
    '        e.Graphics.DrawString(ListBoxCompletedTasksToday.Items(e.Index).ToString, Me.Font, Brushes.Black, 0, e.Bounds.Y + 2)
    '    End If
    'End Sub

    'Private Sub ListBoxCompletedTasksToday_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBoxCompletedTasksToday.SelectedIndexChanged
    '    ListBoxCompletedTasksToday.Refresh()
    'End Sub
