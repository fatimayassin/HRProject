...
Public Class FrmPCSettings
    ...
    'Private Sub tbhostname_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    'Private Sub BtShowHidePass_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub NewBtn_Click(ByVal sender As Object, ByVal e As EventArgs)
    ...
    'Private Sub SelAccbtn_Click(ByVal sender As Object, ByVal e As EventArgs)
    ...
    'Private Sub DelAccBtn_Click_1(ByVal sender As Object, ByVal e As EventArgs)
    '    If lbAcc.SelectedIndex = -1 Then
    ...
    Public Sub FrmPCSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        BtPanelCol.BackColor = My.Settings.PanelColor
        BtBackgroundCol.BackColor = My.Settings.PanelColor
        BtSaveChanges.BackColor = My.Settings.PanelColor
    ...
    'Private Sub lbAcc_SelectedIndexChanged(sender As Object, e As EventArgs)
    '    If lbAcc.SelectedIndex = -1 Then
    '        MessageBox.Show("Please Select An Account From List First !")
    '        Return
    '    End If
    ...
    'Private Sub CheckBoxRemember_CheckedChanged(sender As Object, e As EventArgs)
    '    If CheckBoxRemember.Checked = True Then
    ...
    'Private Sub bPickPath_Click(sender As Object, e As EventArgs)
    ...
    Private Sub BtPanelCol_Click(sender As Object, e As EventArgs) Handles BtPanelCol.Click
    ...
    Private Sub BtBackgroundCol_Click(sender As Object, e As EventArgs) Handles BtBackgroundCol.Click
        Dim ColorDialog1 As New ColorDialog
        ColorDialog1.AllowFullOpen = True
        ColorDialog1.AnyColor = True
        ColorDialog1.SolidColorOnly = False
        ...
        If (ColorDialog1.ShowDialog() = DialogResult.OK) Then
            My.Settings.FormBackgroundColor = ColorDialog1.Color
            My.Settings.Save()
    ...
    Private Sub BtSaveChanges_Click(sender As Object, e As EventArgs) Handles BtSaveChanges.Click
        Me.BackColor = My.Settings.FormBackgroundColor
        Panel2.BackColor = My.Settings.FormBackgroundColor
        Panel1.BackColor = My.Settings.PanelColor

        MessageBox.Show("Theme is Saved")
        Me.Close()
    End Sub
