...
Public Class ShowMessagePOP
    Public Sub New(message As Rfc822Message)
        InitializeComponent()
        Fill(message)
    End Sub

    Private Sub Fill(message As Rfc822Message)
        ...
        For Each attachment As Attachment In message.Attachments
            'transfer file name "Empty" with send mail App Just on POP 
    ...
    Private Sub ShowMessagePOP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
