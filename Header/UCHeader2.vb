Public Class UCHeader2
    ...
    Public Sub InitHeaderBody(ByVal ParentForm As Form, ByVal mMainColor As Color, ByVal mMainColorLight As Color, ByVal mMaincolorDark As Color, ByVal mMainColorText As Color, ByVal mmaincolor2 As Color, ByVal mmaincolor2dark As Color, ByVal mmaincolor2light As Color, ByVal mTextColor2 As Color, ByVal mViewSettingButton As Boolean, ByVal mViewRefreshButton As Boolean, ByVal mViewCounter As Boolean, ByVal mViewMinimizeButton As Boolean, ByVal mViewMaximizeButton As Boolean, ByVal mViewCloseButton As Boolean, ByVal mViewLogoutButton As Boolean, ByVal mViewLogedInName As Boolean)
    ...
    'Private Sub lbl_MouseEnter_1(sender As Object, e As EventArgs)
    '    sender.BackColor = MainColorLight
    '    ToolTip1.Show("Maximize", lblWindowsState)

    'End Sub

    'Private Sub lbl_MouseLeave_1(sender As Object, e As EventArgs)
    '    sender.BackColor = Nothing
    '    sender.ForeColor = Nothing
    '    ToolTip1.Hide(sender)
    'End Sub

    'Private Sub lblMinimize_MouseEnter_2(sender As Object, e As EventArgs)
    '    sender.BackColor = MainColorLight
    '    ToolTip1.Show("Minimize", lblMinimize)
    'End Sub

    'Private Sub lblsetting_MouseEnter_2(sender As Object, e As EventArgs)
    ...
    'Private Sub lblLeft2Ref_MouseEnter_1(sender As Object, e As EventArgs)
    '    sender.BackColor = Color.Green
    '    ToolTip1.Show("Refresh", lblLeft2Ref)
    'End Sub

    'Private Sub lblLeft2Ref_MouseLeave_1(sender As Object, e As EventArgs)
    '    sender.BackColor = Nothing
    '    ToolTip1.Hide(sender)
    'End Sub
    ...
    'Private Sub lblClose_MouseEnter_1(sender As Object, e As EventArgs)
    '    sender.BackColor = Color.Red
    '    ToolTip1.Show("Close", lblClose)
    'End Sub

    'Private Sub lblClose_MouseLeave_1(sender As Object, e As EventArgs)
    '    sender.BackColor = Nothing
    '    ToolTip1.Hide(sender)
    'End Sub
    'Private Sub lblWindowsState_Click(sender As Object, e As EventArgs)
    ...
    'End Sub
    'Private Sub lblHeaderText_MouseDown(sender As Object, e As MouseEventArgs)
    ...
    'Private Sub lblHeaderText_MouseUp(sender As Object, e As MouseEventArgs)
    '    ' If f.WindowState = FormWindowState.Normal Then
    '    Timer1.Enabled = False
    '    ' End If
    'End Sub
    ...
    'Private Sub lblLeft2Ref_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub lblLeft1Setting_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub lblHeaderText_DoubleClick(sender As Object, e As EventArgs)
