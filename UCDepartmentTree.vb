Public Class UCDepartmentTree
    ...
    Private Sub UCDepartmentTree_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Panel1.Visible = True
    ...
    Private Sub TreeViewDepartments_NodeMouseClick(ByVal sender As Object, ByVal e As TreeNodeMouseClickEventArgs) Handles TreeViewDepartments.NodeMouseClick
    ...
    Private Sub AddJobToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs) Handles AddJobToolStripMenuItem.Click
        nodeTag = Integer.Parse(TreeViewDepartments.SelectedNode.Tag.ToString)
